# Current VP8L symbolic Callgrind profile v5
...
```text
41,902,570 (100.0%)  PROGRAM TOTALS
10,200,808 (24.34%)  src/lossless/decoder/mod.rs:<image_webp::lossless::decoder::LosslessDecoder<core::io::util::Take<&mut core::io::cursor::Cursor<alloc::vec::Vec<u8>>>>>::decode_image_stream [/home/runner/work/image-webp/image-webp/target/release/examples/profile_vp8l_v5]
...
1,233,291 ( 2.94%)  => /home/runner/work/image-webp/image-webp/src/lossless/decoder/huffman.rs:<image_webp::lossless::decoder::huffman::HuffmanTree<9>>::build_implicit::<alloc::vec::Vec<u16>> (123x)
...
26,520,974 (63.29%)  => src/lossless/decoder/mod.rs:<image_webp::lossless::decoder::LosslessDecoder<core::io::util::Take<&mut core::io::cursor::Cursor<alloc::vec::Vec<u8>>>>>::decode_image_stream (1x)
        .                               predictor_data,
...
2,390,353 ( 5.70%)  => src/lossless/decoder/mod.rs:<image_webp::lossless::decoder::LosslessDecoder<core::io::util::Take<&mut core::io::cursor::Cursor<alloc::vec::Vec<u8>>>>>::read_huffman_codes (3x)
   ...
   92,379 ( 0.22%)  => src/lossless/decoder/mod.rs:<image_webp::lossless::decoder::LosslessDecoder<core::io::util::Take<&mut core::io::cursor::Cursor<alloc::vec::Vec<u8>>>>>::decode_image_stream (1x)
        .                                   predictor_data,
       10 ( 0.00%)                      self.decode_image_stream(block_xsize, block_ysize, false, &mut transform_data)?;
  168,291 ( 0.40%)  => src/lossless/decoder/mod.rs:<image_webp::lossless::decoder::LosslessDecoder<core::io::util::Take<&mut core::io::cursor::Cursor<alloc::vec::Vec<u8>>>>>::decode_image_stream (1x)
   ...
   95,064 ( 0.23%)  => src/lossless/decoder/mod.rs:<image_webp::lossless::decoder::LosslessDecoder<core::io::util::Take<&mut core::io::cursor::Cursor<alloc::vec::Vec<u8>>>>>::decode_image_stream'2 (1x)
  ...
  226,221 ( 0.54%)  => /home/runner/work/image-webp/image-webp/src/lossless/decoder/huffman.rs:<image_webp::lossless::decoder::huffman::HuffmanTree<9>>::build_implicit::<&[u16]> (123x)
        ...
        .                               color_cache,
        .                               color_cache,
   54,716 ( 0.13%)  => /rustc/88d9e12ae178fab0fb5cc050a94da85685d449ea/library/core/src/ptr/mod.rs:core::ptr::drop_glue::<image_webp::lossless::decoder::HuffmanInfo> (3x)
